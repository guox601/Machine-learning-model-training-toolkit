...
%BPANNEGRESSIONHOLD MATLAB code file for BpANNegressionHold.fig
...
%
%      BPANNEGRESSIONHOLD('Property','Value',...) creates a new BPANNEGRESSIONHOLD using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to BpANNegressionHold_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      BPANNEGRESSIONHOLD('CALLBACK') and BPANNEGRESSIONHOLD('CALLBACK',hObject,...) call the
%      local function named CALLBACK in BPANNEGRESSIONHOLD.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 03-Jun-2025 20:48:21
